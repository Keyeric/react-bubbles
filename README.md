...
Easy-to-pass-around JSON for authentication

- [ ] What steps can you take in your web apps to keep your data secure?

passing tests, authentications, and fixing securtiy vulverabilities

- [ ] Describe how web servers work.

a computer somewhere runs a program of the same name and projects it onto the internet
...
- [ ] Create a new Branch on the clone: gcb `<firstName-lastName>`.
- [ ] Implement the project on this Branch, committing changes regularly (gaa -> gcmsg "").
- [ ] Push commits: git push origin `<firstName-lastName>`(gpsup || gp).
